...
function StudentsModule() {
  ...
  const addTeacher = async() => {
    ...
    setLoader(true);
    const res = await createStudent(name, email, password, phoneNumber, courseId, 2, 1);
    if (res.status === 200) {
  ...
  const clearFields = async() => {
    ...
    document.getElementById("adminStudentCourseSelect").value = "";
  ...
  const getSingleTeacher = async(ele) => {
    ...
    document.getElementById("adminStudentCourseSelect").value = ele.courseId[0];
                                ...
                                studentsSelector.map((eleAdminStudent, index) => {
                                  return (<>
                                    <tr>
                                      ...
                                      <td>{eleAdminStudent.courses[0].name}</td>
                ...
                <div className="modal-body text-start">
                  ...
                  <div className="row">
                    <div className="col mb-3">
                      ...
                      <select className="form-select" id="adminStudentCourseSelect"  onChange={(e) => { setCourseId(e.target.value) }} disabled={ addEdit === 2 && true }>
