...
export const createTeachers = async(name, email, password, phoneNumber, courseId, role, status) => {
...
export const updateTeacher = async(name, email, phoneNumber, courseId, _id) => {
